...
void load_idt_entries(){
  ...
  create_idt_entry(INT_TIMER, (uint64_t)&timer_handler, INT_GATE_64); // timer handler
  create_idt_entry(INT_KEYBOARD, (uint64_t)&keyboard_handler, INT_GATE_64); // timer handler
}
